...
export default function App() {
  const [lang, setLang] = useState("el" as "el" | "en");
  ...
  function nextLang(cur: "el" | "en") { return cur === "el" ? "en" : "el"; }
  ...
  return (<div className="min-h-screen bg-[conic-gradient(at_50%_-10%,#f8fafc,#ffffff,#f8fafc)] text-slate-800">
    ...
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl leading-tight">{t.heroTitle}</h1>
...
const translations: Record<string, any> = {
  el: {
    ...
    dateValue: "Παρασκευή • 13 Ιουνίου 2026",
